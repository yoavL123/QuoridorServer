...
namespace QuoridorServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string connectionString = this.Configuration.GetConnectionString("QuoridorDB");

            services.AddDbContext<QuoridorDBContext>(options => options
        ...
        #region Add constrctor with Configuration using Dependency Injection
